...
This was a challenge both because of the historical accuracy required in the art style, type, color choices and layout, and because the simple art style of the time period leaves no place to hide errors. It was a further challenge for me because the comics I am both most familiar with and prefer the style of are the bronze age comics from the 80's and early 90's. While I do not think I completely nailed the historical accuracy part of the assignment, I was pleased with the final result and thought I did better adapting to the simpler style than I envisioned I would.</p>",
										...
										'carousel' => [
											['image_url' => ARTWORK_IMAGE_URL.'allen-garvey-personal-comic-book.jpg', 'alt' => 'Self-portrait illustration of Allen Garvey as a classic comic book superhero'],
											['image_url' => ARTWORK_IMAGE_URL.'allen-garvey-personal-comic-book1.jpg', 'alt' => 'Initial sketch of illustration of Allen Garvey as a classic comic book superhero', 'caption' => '<p>Initial sketch</p>'],
											['image_url' => ARTWORK_IMAGE_URL.'allen-garvey-personal-comic-book2.jpg', 'alt' => 'Initial sketch of background for illustration of Allen Garvey as a classic comic book superhero', 'caption' => '<p>Background sketch with completed vector body</p>'],
											['image_url' => ARTWORK_IMAGE_URL.'allen-garvey-personal-comic-book3.svg', 'alt' => 'Black and white illustration of Allen Garvey as a classic comic book superhero', 'caption' => '<p>Completed vector trace in black and white</p>']
										]
										];
	...
	$artworks['jk-simmons-illustration'] = ['title' => 'J.K. Simmons Celebrity Illustration', 
										...
										'orientation' => 'portrait',
										'carousel' => [
											['image_url' => ARTWORK_IMAGE_URL.'jk-simmons-illustration.png', 'alt' => 'Digital illustration of J.K. Simmons by Allen Garvey based on photo by Mark Mann'],
											['image_url' => ARTWORK_IMAGE_URL.'jk-simmons-illustration1.jpg', 'alt' => 'Initial sketch for illustration of J.K. Simmons by Allen Garvey', 'caption' => '<p>Initial sketch</p>'],
											['image_url' => ARTWORK_IMAGE_URL.'jk-simmons-illustration2.jpg', 'alt' => 'Refined sketch for illustration of J.K. Simmons by Allen Garvey', 'caption' => '<p>Refined sketch with smoother shapes for vector tracing</p>'],
											['image_url' => ARTWORK_IMAGE_URL.'jk-simmons-illustration3.png', 'alt' => 'Black and white illustration of J.K. Simmons by Allen Garvey', 'caption' => '<p>Completed vector trace in black and white with top of the head added</p>']
										]
										];
	...
	$artworks['bitter-polar-bear'] = ['title' => 'Bitter Polar Bear', 
										...
										'orientation' => 'portrait',
										'carousel' => [
											['image_url' => ARTWORK_IMAGE_URL.'bitter-polar-bear.png', 'alt' => 'Digital illustration of a bitter polar bear by Allen Garvey based on photo by Mike Reyfman'],
											['image_url' => ARTWORK_IMAGE_URL.'bitter-polar-bear1.jpg', 'alt' => 'Pen outline of initial sketch of a bitter polar bear by Allen Garvey', 'caption' => '<p>Initial sketch outlined in pen</p>'],
											['image_url' => ARTWORK_IMAGE_URL.'bitter-polar-bear2.jpg', 'alt' => 'Refined sketch for illustration of J.K. Simmons by Allen Garvey', 'caption' => '<p>Right half reversed to create symmetrical drawing</p>'],
											['image_url' => ARTWORK_IMAGE_URL.'bitter-polar-bear3.jpg', 'alt' => 'Smooth pen outline for illustration of J.K. Simmons by Allen Garvey', 'caption' => '<p>Smoother pen outline with asymmetry added</p>'],
											['image_url' => ARTWORK_IMAGE_URL.'bitter-polar-bear4.jpg', 'alt' => 'Further refined sketch for illustration of J.K. Simmons by Allen Garvey', 'caption' => '<p>More detail sketched over vector printout</p>']
